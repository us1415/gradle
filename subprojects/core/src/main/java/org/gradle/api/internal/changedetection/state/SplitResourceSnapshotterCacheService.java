...
public class SplitResourceSnapshotterCacheService implements ResourceSnapshotterCacheService {
    ...
    public SplitResourceSnapshotterCacheService(ResourceSnapshotterCacheService globalCache, ResourceSnapshotterCacheService localCache, FileCategorizer fileCategorizer) {
    ...
    public HashCode hashFile(RegularFileSnapshot fileSnapshot, RegularFileHasher hasher, HashCode configurationHash) {
        if (fileCategorizer.isImmutable(fileSnapshot.getPath())) {
